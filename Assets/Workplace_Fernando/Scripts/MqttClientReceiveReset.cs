...
//using Meta.XR.Interaction.Locomotion;
//using Oculus.Interaction.Locomotion;

namespace ExtralityLab
{
    public class MqttClientReceiveReset : M2MqttUnityClient
    {
        ...
        private void ProcessMessage(string msg)
        {
            ...
            if (msg.CompareTo("0") == 0) msg = "false"; // Not-pressed
            if (msg.CompareTo("1") == 0) msg = "true"; // Pressed
